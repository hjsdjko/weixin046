...
public class PeisongyuanEntity<T> implements Serializable {
	...
	private String peisongyuanmima;
	 ...
	 * 设置：配送员密码
	 */
	public void setPeisongyuanmima(String peisongyuanmima) {
		this.peisongyuanmima = peisongyuanmima;
	}
	/**
	 * 获取：配送员密码
	 */
	public String getPeisongyuanmima() {
		return peisongyuanmima;
	}
	/**
	 * 设置：配送员姓名
	 */
