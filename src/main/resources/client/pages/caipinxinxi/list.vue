		...
		<view :style='{"minHeight":"100vh","width":"100%","padding":"20rpx 0 0 0","position":"relative","background":"#ff993310","height":"auto"}'>
			<view :style='{"padding":"20rpx 0 0 0","alignItems":"center","flex":"1","display":"flex","width":"calc(98% - 120rpx)","position":"relative","justifyContent":"space-between"}'>
				<view :style='{"border":"2rpx solid #ff993350","backgroundColor":"#ffffff","margin":"0 30rpx 0 30rpx","color":"#333333","alignItems":"center","borderRadius":"0px","flex":"1","display":"flex","lineHeight":"64rpx","fontSize":"24rpx","height":"64rpx"}'>
					...
					<input v-model="searchForm.caipinmingcheng" type="text" placeholder="菜品名称" :style='{"background":"#ffffff","height":"100%"}'></input>
				</view>
			...
			<view class="uni-product-list" :style='{"padding":"24rpx 24rpx 24rpx 24rpx","margin":"0px 0 0 0","alignItems":"flex-start","flexWrap":"wrap","display":"flex","width":"100%","justifyContent":"space-between","height":"auto","order":"3"}'>
				<view @tap="onDetailTap(product)" class="uni-product" :style='{"margin":"0 0 40rpx 0","borderRadius":"8rpx","flexWrap":"wrap","textAlign":"center","background":"none","display":"flex","width":"48%","justifyContent":"center","height":"auto"}' v-for="(product,index) in list" :key="index">
					<view class="uni-product-title" :style='{"padding":"0px 20rpx 0px 20rpx","margin":"0 0 0px 0","whiteSpace":"nowrap","color":"#333333","textAlign":"left","overflow":"hidden","borderRadius":"8rpx","width":"100%","lineHeight":"72rpx","fontSize":"28rpx","textOverflow":"ellipsis","order":"2","height":"72rpx"}'>{{product.caipinmingcheng}}</view>
					<image :style='{"border":"0px solid #eeeeee","padding":"0 0 0 0","margin":"0 0 0px 0","objectFit":"cover","borderRadius":"8rpx","display":"inline-block","width":"100%","height":"240rpx"}' mode="aspectFill" class="uni-product-image" v-if="preHttp(product.caipintupian)" :src="product.caipintupian.split(',')[0]"></image>
					<image :style='{"border":"0px solid #eeeeee","padding":"0 0 0 0","margin":"0 0 0px 0","objectFit":"cover","borderRadius":"8rpx","display":"inline-block","width":"100%","height":"240rpx"}' mode="aspectFill" class="uni-product-image" v-else :src="product.caipintupian?baseUrl+product.caipintupian.split(',')[0]:''"></image>
					<view class="uni-product-title" :style='{"padding":"0px 20rpx 0px 20rpx","margin":"0 0 0px 0","whiteSpace":"nowrap","color":"#333333","textAlign":"left","overflow":"hidden","borderRadius":"8rpx","width":"100%","lineHeight":"72rpx","fontSize":"28rpx","textOverflow":"ellipsis","order":"2","height":"72rpx"}'>{{product.caipinfenlei}}</view>
